...
export class PetitionComponent {
  ...
  getData(doctorsID: string) {
    this.api.getPetitionByUserID(doctorsID).subscribe(
  ...
  viewUser(customerID: number, appointmentID: number): void {
    this.router.navigate(['/chat'], {
      queryParams: { chatUserID: customerID, appointmentId: appointmentID }
    });
  }
